...
async def test_mux(dut):
    ...
    assert dut.out.value == dut.inp11.value, f"Mux result is incorrect: {dut.out.value} != {dut.inp11.value}"
    print("                      inp11 : %d, out : %d, sel : %d" % (dut.inp11.value,dut.out.value,dut.sel.value))
