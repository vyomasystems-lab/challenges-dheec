...
async def test_mux(dut):
    ...
    assert dut.out.value == dut.inp10.value, f"Mux result is incorrect: {dut.out.value} != {dut.inp10.value}"
    print("                      inp10 : %d, out : %d, sel : %d" % (dut.inp10.value,dut.out.value,dut.sel.value))
