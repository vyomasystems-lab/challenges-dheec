...
async def test_mux(dut):
    ...
    assert dut.out.value == dut.inp31.value, f"Mux result is incorrect: {dut.out.value} != {dut.inp31.value}"
    print("                      inp31 : %d, out : %d, sel : %d" % (dut.inp31.value,dut.out.value,dut.sel.value))
