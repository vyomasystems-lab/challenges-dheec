...
async def test_mux(dut):
    ...
    assert dut.out.value == dut.inp8.value, f"Mux result is incorrect: {dut.out.value} != {dut.inp8.value}"
    print("                      inp8 : %d, out : %d, sel : %d" % (dut.inp8.value,dut.out.value,dut.sel.value))
