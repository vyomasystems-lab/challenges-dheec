...
async def test_mux(dut):
    ...
    assert dut.out.value == dut.inp12.value, f"Mux result is incorrect: {dut.out.value} != {dut.inp12.value}"
    print("                      inp12 : %d, out : %d, sel : %d" % (dut.inp12.value,dut.out.value,dut.sel.value))
